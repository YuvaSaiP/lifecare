    ...
    <div>
      <CategoryWrapper>
        <EachItemContainer
          style={{
            ...
            backgroundImage: `url("https://images.adsttc.com/media/images/53bf/72df/c07a/8034/c400/011e/large_jpg/00portada.jpg?1405055698")`,
          }}
        >
          <EachItemDiv>
            <Button>Johnson BLOOD BANK</Button>
          </EachItemDiv>
        </EachItemContainer>
        <EachItemContainer
          style={{
      ...
      rgba(255, 0, 0, 0.15)
        ...
        >
          <EachItemDiv>
            <Link to="/details">
              <Button>SVIMS BLOOD BANK</Button>
            </Link>
          </EachItemDiv>
        </EachItemContainer>
        <EachItemContainer
        ...
        >
          <EachItemDiv>
            <Button>Vasan BLOOD BANK</Button>
          </EachItemDiv>
        </EachItemContainer>
        <EachItemContainer
          style={{
